...
describe('VisualEffects - Advanced Tests', () => {
  ...
  describe('Audio Data Visualization', () => {
    it('should process frequency data for spectrum visualization', async () => {
      ...
      render(<VisualEffects audioData={audioData} effectType="spectrum" colorTheme="#00ccff" />);
    ...
    it('should handle silent audio input gracefully', async () => {
      ...
      render(<VisualEffects audioData={silentAudio} effectType="spectrum" colorTheme="#00ccff" />);
    ...
    it('should update visualization when audio data changes', async () => {
      const { rerender } = render(
        <VisualEffects audioData={mockStore.audioData} effectType="waveform" colorTheme="#00ccff" />
      );
      ...
      rerender(
        <VisualEffects audioData={newAudioData} effectType="waveform" colorTheme="#00ccff" />
      );
  ...
  describe('Visual Effects', () => {
    it('should apply color themes correctly', async () => {
      ...
      for (const color of colorThemes) {
        render(
          <VisualEffects audioData={mockStore.audioData} effectType="spectrum" colorTheme={color} />
        );
    ...
    it('should handle gradient creation for effects', async () => {
      render(
        <VisualEffects audioData={mockStore.audioData} effectType="circular" colorTheme="#00ccff" />
      );
  ...
  describe('Canvas Resizing', () => {
    it('should handle canvas resize events', async () => {
      const { container } = render(
        <VisualEffects audioData={mockStore.audioData} effectType="spectrum" colorTheme="#00ccff" />
      );
  ...
  describe('Error Handling', () => {
    it('should handle invalid audio data gracefully', async () => {
      ...
      render(<VisualEffects effectType="spectrum" colorTheme="#00ccff" />);
